...
func init() {
	printFacturaCmd.Flags().BoolVarP(&pdfFlag, "pdf", "p", false, "Convert output to PDF")
	AdmCmd.AddCommand(printFacturaCmd)
	printCotizacionCmd.Flags().BoolVarP(&pdfFlag, "pdf", "p", false, "Convert output to PDF")
	AdmCmd.AddCommand(printCotizacionCmd)
}
